function startLayout(){
	...
	if(sidebarState == 'none'){
		$('.mainContentsWrapper').css({'margin-left': '0', 'width': 'auto'} );
	}else{	
	}	
}
...
function searchOverlay() {
	...
	$('.advanceSearch').click(function () {
			$('body').prepend('<div class="transpOverlay" style="background:url(images/bg_password.png) repeat left top; width:100%; height:100%;position:absolute; top:0; left:0; z-index:120;"></div>');
