...
function DATA_ON_LOAD(){
	...
	/*$("#accordion-1").append('<li><a href="#"><input type="checkbox" />Desktop</a><ul><li><a href="#"><input type="checkbox" />Product 4</a></li><li><a href="#"><input type="checkbox" />Product 5</a></li><li><a href="#"><input type="checkbox" />Product 6</a></li><li><a href="#"><input type="checkbox" />Product 7</a></li><li><a href="#"><input type="checkbox" />Product 8</a></li><li><a href="#"><input type="checkbox" />Product 9</a></li></ul></li>');*/
...
function LOAD_ST_DIST(){
	...
	/*			$("#accordion-1").append('<li id='+st_code+'><a href="#"><input type="checkbox" />'+stname+'</a><li>');
				$("#"+st_code+"").append('<ul id="masta"></ul>');
				webMethod = CXFServiceURL+"DistrictDetailService/Country/districtDetails";
				...
				xhr=$.ajax({
					...
					success: function(resp) {
						...
						//alert(distid);
						$("#masta").append('<li><a href="#"><input type="checkbox" />'+distname+'</a></li>');			
						});
					}
				});
				*/
			...
			/*	$("#masta").append('<li><a href="#"><input type="checkbox" />Product 4</a></li><li><a href="#"><input type="checkbox" />Product 5</a></li><li><a href="#"><input type="checkbox" />Product 6</a></li><li><a href="#"><input type="checkbox" />Product 7</a></li><li><a href="#"><input type="checkbox" />Product 8</a></li><li><a href="#"><input type="checkbox" />Product 9</a></li>');
				$("#masta").append('<li><a href="#"><input type="checkbox" />abhishek</a></li>');*/
				/*$("#"+st_code+"").append('<ul><li><a href="#"><input type="checkbox" />Product 4</a></li><li><a href="#"><input type="checkbox" />Product 5</a></li><li><a href="#"><input type="checkbox" />Product 6</a></li><li><a href="#"><input type="checkbox" />Product 7</a></li><li><a href="#"><input type="checkbox" />Product 8</a></li><li><a href="#"><input type="checkbox" />Product 9</a></li></ul>');*/
				json["name"]=stname;
				json["tot_p"]=totalp;
				json["tot_irr"]=irr;
				json["power"]=pow;
